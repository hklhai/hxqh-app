...
<div class="left-menu">
	<ul id="menu">
		...
		<li class="menu-list">
			...
			<ul>
				<li><a href="${ctx}/query/list" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Wifi Traffic</a></li>
				<li><a href="${ctx}/query/authorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Number of Access Point</a></li>
				<li><a href="${ctx}/query/webProductStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Ticket Monitoring</a></li>
				<li><a href="${ctx}/query/showWebAuthorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Daily Ticket Distribution</a></li>
				<li><a href="${ctx}/query/showAuthorWebStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MTTR Targets<li><a href="${ctx}/query/showWebsiteList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Monitoring MTTR Proactive</a></li>
				<li><a href="${ctx}/query/surveyList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>Wifi Map</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>WAG & Controller</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>EVENT BUMN LABUHAN BAJO</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>WIFI_99</a></li>
			</ul>
		</li>
		<li class="menu-list">
		...
		<li class="menu-list">
			...
			<ul>
				<li><a href="${ctx}/query/list" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-85</a></li>
				<li><a href="${ctx}/query/authorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-87</a></li>
				<li><a href="${ctx}/query/webProductStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-86</a></li>

				<li><a href="${ctx}/query/showWebAuthorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-88</a></li>
				<li><a href="${ctx}/query/showAuthorWebStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-88</a></li>
				<li><a href="${ctx}/query/showWebsiteList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-91</a></li>
				<li><a href="${ctx}/query/surveyList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-90</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-92</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>MOB-89</a></li>
			</ul>
		</li>
		<li class="menu-list">
			<a  target="menuFrame" class="firsta"><i  class="glyph-icon zzgl"></i>IOC DIGITAL<span class="sz"></span></a>
			<ul>
				<li><a href="${ctx}/query/list" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-13</a></li>
				<li><a href="${ctx}/query/authorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-14</a></li>
				<li><a href="${ctx}/query/webProductStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-15</a></li>

				<li><a href="${ctx}/query/showWebAuthorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-17</a></li>
				<li><a href="${ctx}/query/showAuthorWebStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-18</a></li>
				<li><a href="${ctx}/query/showWebsiteList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-19</a></li>
				<li><a href="${ctx}/query/surveyList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-13,14,17,18</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>ImageUpload</a></li>
				<li><a href="${ctx}/query/getWebsitestatisticList" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>DIG-16,20</a></li>
			</ul>
		</li>
		<li class="menu-list">
			<a  target="menuFrame" class="firsta"><i  class="glyph-icon zzgl"></i>IOC ANO<span class="sz"></span></a>
			<ul>
				<li><a href="${ctx}/query/list" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>ANO-81</a></li>
				<li><a href="${ctx}/query/authorStatistic" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>ANO-82</a></li>
			</ul>
		</li>
		<li class="menu-list">
