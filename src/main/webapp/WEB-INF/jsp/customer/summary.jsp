...
<div class="ind-layout">
	<table>
		...
		<tr>
			...
			<td colspan="14">CONSUMER TOP 20</td>
			<td colspan="7">CONSUMER TOP 20</td>
		...
		<tr>
			...
			<td colspan="7">PL(PLATINUM 24 JAM)</td>
			<td colspan="7">PL(TITANIUM & GOLD 48JAM)</td>
			<td colspan="7">PL(SILVER 72JAM)</td>
		</tr>
		<tr>
			<td>A</td>
			<td>B</td>
		...
		<tr>
			<td>TREG 1</td>
			<td class="font-red">72</td>s
			<td class="font-yellow">72</td>
			<td class="font-blue">72</td>
			<td class="font-green">72</td>
			<td>72</td>
			<td>72</td>
			<td>72</td>
